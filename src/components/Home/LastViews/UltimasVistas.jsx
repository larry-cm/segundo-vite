    ...
    <div className=' mb-6'>
      ...
      <ul className='flex flex-wrap gap-4 '>
        {ultimasVistas.length
          ...
          : (<h3 className=' flex items-center rounded-2xl py-2 px-4 shadow-2xs transition-colors duration-300 bg-primary font-medium text-text min-h-[42px]'>Navega entre categorías o búsquedas para tener un historial</h3>)}
      </ul>
    </div>
  )
}
